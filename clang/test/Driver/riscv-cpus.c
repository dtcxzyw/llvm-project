...
// RUN: %clang --target=riscv64 -### -c %s 2>&1 -mcpu=xiangshan-yanqihu | FileCheck -check-prefix=MCPU-XIANGSHAN-YANQIHU %s
// MCPU-XIANGSHAN-YANQIHU: "-nostdsysteminc" "-target-cpu" "xiangshan-yanqihu"
// MCPU-XIANGSHAN-YANQIHU: "-target-feature" "+m" "-target-feature" "+a" "-target-feature" "+f" "-target-feature" "+d"
// MCPU-XIANGSHAN-YANQIHU: "-target-feature" "+c"
// MCPU-XIANGSHAN-YANQIHU: "-target-feature" "+zicsr" "-target-feature" "+zifencei"
// MCPU-XIANGSHAN-YANQIHU: "-target-abi" "lp64d"
...
// MCPU-XIANGSHAN-KUNMINGHU: "-target-feature" "+m" "-target-feature" "+a" "-target-feature" "+f" "-target-feature" "+d"
// MCPU-XIANGSHAN-KUNMINGHU: "-target-feature" "+c" "-target-feature" "+v" "-target-feature" "+h"
// MCPU-XIANGSHAN-KUNMINGHU: "-target-feature" "+zicbom" "-target-feature" "+zicboz" "-target-feature" "+zicsr" "-target-feature" "+zifencei"
// MCPU-XIANGSHAN-KUNMINGHU: "-target-feature" "+zba" "-target-feature" "+zbb" "-target-feature" "+zbc"
// MCPU-XIANGSHAN-KUNMINGHU: "-target-feature" "+zbkb" "-target-feature" "+zbkc" "-target-feature" "+zbkx" "-target-feature" "+zbs"
// MCPU-XIANGSHAN-KUNMINGHU: "-target-feature" "+zkn" "-target-feature" "+zknd" "-target-feature" "+zkne" "-target-feature" "+zknh"
// MCPU-XIANGSHAN-KUNMINGHU: "-target-feature" "+zks" "-target-feature" "+zksed" "-target-feature" "+zksh" 
// MCPU-XIANGSHAN-KUNMINGHU: "-target-feature" "+svinval"
// MCPU-XIANGSHAN-KUNMINGHU: "-target-abi" "lp64d"
...
// RUN: %clang --target=riscv64 -### -c %s 2>&1 -mtune=xiangshan-yanqihu | FileCheck -check-prefix=MTUNE-XIANGSHAN-YANQIHU %s
// MTUNE-XIANGSHAN-YANQIHU: "-tune-cpu" "xiangshan-yanqihu"
