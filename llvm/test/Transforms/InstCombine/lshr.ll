...
; CHECK-NEXT:    [[SH:%.*]] = sext i3 [[TMP1]] to i18
...
; CHECK-NEXT:    [[SH:%.*]] = sext <2 x i3> [[TMP1]] to <2 x i8>
; CHECK-NEXT:    ret <2 x i8> [[SH]]
;
...
; CHECK-NEXT:    [[SH:%.*]] = sext <2 x i8> [[TMP1]] to <2 x i32>
...
; CHECK-NEXT:    [[S:%.*]] = sext <2 x i32> [[TMP2]] to <2 x i64>
; CHECK-NEXT:    ret <2 x i64> [[S]]
;
...
; CHECK-NEXT:    [[S:%.*]] = sext i96 [[TMP2]] to i128
; CHECK-NEXT:    ret i128 [[S]]
;
