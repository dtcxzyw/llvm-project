...
; CHECK-NEXT:    [[ROUNDXDOWNTOMULTIPLEOFY:%.*]] = mul nsw i8 [[DIV]], [[Y]]
...
; CHECK-NEXT:    [[ROUNDXDOWNTOMULTIPLEOFY:%.*]] = mul nsw <2 x i8> [[DIV]], [[Y]]
...
; CHECK-NEXT:    [[DIV:%.*]] = sdiv i8 [[X:%.*]], [[Y]]
; CHECK-NEXT:    call void @use8(i8 [[DIV]])
; CHECK-NEXT:    [[ROUNDXDOWNTOMULTIPLEOFY:%.*]] = mul nsw i8 [[Y]], [[DIV]]
; CHECK-NEXT:    [[REM:%.*]] = sub i8 [[X]], [[ROUNDXDOWNTOMULTIPLEOFY]]
; CHECK-NEXT:    ret i8 [[REM]]
;
  %y = call i8 @gen8()
