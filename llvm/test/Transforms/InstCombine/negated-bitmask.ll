...
; CHECK-NEXT:    [[NEG:%.*]] = sext i8 [[NARROW]] to i32
...
; CHECK-NEXT:    [[S_NEG:%.*]] = ashr i8 [[X:%.*]], 7
; CHECK-NEXT:    [[R:%.*]] = sext i8 [[S_NEG]] to i32
...
; CHECK-NEXT:    [[NARROW:%.*]] = sub nsw i8 0, [[S]]
