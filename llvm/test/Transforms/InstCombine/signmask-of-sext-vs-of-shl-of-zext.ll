...
define i32 @t0(i16 %x) {
; CHECK-LABEL: @t0(
; CHECK-NEXT:    [[I01:%.*]] = sext i16 [[X:%.*]] to i32
; CHECK-NEXT:    [[I1:%.*]] = shl nsw i32 [[I01]], 16
...
define i32 @t1(i8 %x) {
; CHECK-LABEL: @t1(
; CHECK-NEXT:    [[I01:%.*]] = sext i8 [[X:%.*]] to i32
; CHECK-NEXT:    [[I1:%.*]] = shl nsw i32 [[I01]], 24
; CHECK-NEXT:    [[R:%.*]] = and i32 [[I1]], -2147483648
; CHECK-NEXT:    ret i32 [[R]]
;
  %i0 = zext i8 %x to i32
...
; CHECK-LABEL: @t8(
; CHECK-NEXT:    [[I01:%.*]] = sext <2 x i16> [[X:%.*]] to <2 x i32>
; CHECK-NEXT:    [[I1:%.*]] = shl nsw <2 x i32> [[I01]], <i32 16, i32 16>
