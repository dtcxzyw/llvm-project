...
; CHECK-NEXT:    [[I1_EXT:%.*]] = sext i9 [[I1]] to i16
; CHECK-NEXT:    [[I2_EXT:%.*]] = sext i9 [[I2]] to i16
; CHECK-NEXT:    [[SUB:%.*]] = add nsw i16 [[I1_EXT]], [[I2_EXT]]
; CHECK-NEXT:    [[TMP1:%.*]] = lshr i16 [[SUB]], 1
; CHECK-NEXT:    [[T:%.*]] = trunc i16 [[TMP1]] to i8
; CHECK-NEXT:    ret i8 [[T]]
...
; CHECK-SAME: i8 [[I1:%.*]], i8 [[I2:%.*]]) {
; CHECK-NEXT:    [[I1_EXT:%.*]] = sext i8 [[I1]] to i14
; CHECK-NEXT:    [[I2_EXT:%.*]] = sext i8 [[I2]] to i14
; CHECK-NEXT:    [[SUB:%.*]] = add nsw i14 [[I1_EXT]], [[I2_EXT]]
