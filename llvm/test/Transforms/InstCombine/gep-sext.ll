...
; CHECK-SAME: ptr [[P:%.*]], i32 [[INDEX:%.*]]) {
; CHECK-NEXT:    [[ADDR_BEGIN:%.*]] = getelementptr i32, ptr [[P]], i64 40
; CHECK-NEXT:    [[ADDR_FIXED:%.*]] = getelementptr i32, ptr [[P]], i64 88
; CHECK-NEXT:    [[VAL_FIXED:%.*]] = load i32, ptr [[ADDR_FIXED]], align 4, !range [[RNG0:![0-9]+]]
; CHECK-NEXT:    [[TMP1:%.*]] = sext i32 [[VAL_FIXED]] to i64
...
; CHECK-NEXT:    [[I:%.*]] = sext i32 [[VAL_FIXED]] to i64
