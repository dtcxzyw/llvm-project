...
; CHECK-NEXT:    [[T11:%.*]] = sext i16 [[T0]] to i32
; CHECK-NEXT:    [[T2:%.*]] = shl i32 [[X:%.*]], [[T11]]
...
; CHECK-NEXT:    [[T11:%.*]] = sext <2 x i16> [[T0]] to <2 x i32>
; CHECK-NEXT:    [[T2:%.*]] = shl <2 x i32> [[X:%.*]], [[T11]]
...
; CHECK-NEXT:    [[T0:%.*]] = sub <3 x i16> <i16 32, i16 poison, i16 32>, [[Y:%.*]]
; CHECK-NEXT:    [[T11:%.*]] = sext <3 x i16> [[T0]] to <3 x i32>
; CHECK-NEXT:    [[T2:%.*]] = shl <3 x i32> [[X:%.*]], [[T11]]
...
; CHECK-NEXT:    [[T2:%.*]] = shl <3 x i32> [[X:%.*]], [[T11]]
; CHECK-NEXT:    [[T3:%.*]] = trunc <3 x i32> [[T2]] to <3 x i16>
; CHECK-NEXT:    [[T4:%.*]] = add <3 x i16> [[Y]], <i16 -24, i16 poison, i16 -24>
; CHECK-NEXT:    [[T5:%.*]] = shl <3 x i16> [[T3]], [[T4]]
; CHECK-NEXT:    ret <3 x i16> [[T5]]
;
