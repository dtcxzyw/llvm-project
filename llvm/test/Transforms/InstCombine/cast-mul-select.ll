...
; CHECK-NEXT:    [[R:%.*]] = sext i16 [[M]] to i32
...
; DBGINFO-NEXT:    [[R:%.*]] = sext i16 [[M]] to i32, !dbg [[DBG72:![0-9]+]]
...
; CHECK-NEXT:    [[CONV:%.*]] = sext i8 [[H]] to i32
...
; DBGINFO-NEXT:    [[CONV:%.*]] = sext i8 [[H]] to i32, !dbg [[DBG101:![0-9]+]]
