...
; ALL-NEXT:  entry:
; ALL-NEXT:    [[TOBOOL_NOT4_I:%.*]] = icmp eq ptr [[P:%.*]], null
; ALL-NEXT:    br i1 [[TOBOOL_NOT4_I]], label [[COUNT_NODES_VARIANT2_EXIT:%.*]], label [[WHILE_BODY_I:%.*]]
; ALL:       while.body.i:
; ALL-NEXT:    [[SIZE_06_I:%.*]] = phi i64 [ [[INC_I:%.*]], [[WHILE_BODY_I]] ], [ 0, [[ENTRY:%.*]] ]
; ALL-NEXT:    [[P_ADDR_05_I:%.*]] = phi ptr [ [[TMP0:%.*]], [[WHILE_BODY_I]] ], [ [[P]], [[ENTRY]] ]
; ALL-NEXT:    [[TMP0]] = load ptr, ptr [[P_ADDR_05_I]], align 8
; ALL-NEXT:    [[INC_I]] = add i64 [[SIZE_06_I]], 1
; ALL-NEXT:    [[TOBOOL_NOT_I:%.*]] = icmp eq ptr [[TMP0]], null
; ALL-NEXT:    br i1 [[TOBOOL_NOT_I]], label [[COUNT_NODES_VARIANT2_EXIT_LOOPEXIT:%.*]], label [[WHILE_BODY_I]], !llvm.loop [[LOOP0:![0-9]+]]
; ALL:       count_nodes_variant2.exit.loopexit:
; ALL-NEXT:    [[TMP1:%.*]] = icmp ne i64 [[INC_I]], 0
; ALL-NEXT:    br label [[COUNT_NODES_VARIANT2_EXIT]]
; ALL:       count_nodes_variant2.exit:
; ALL-NEXT:    [[SIZE_0_LCSSA_I:%.*]] = phi i1 [ false, [[ENTRY]] ], [ [[TMP1]], [[COUNT_NODES_VARIANT2_EXIT_LOOPEXIT]] ]
...
; ALL-NEXT:  entry:
; ALL-NEXT:    [[TOBOOL_NOT4_I:%.*]] = icmp eq ptr [[P:%.*]], null
; ALL-NEXT:    br i1 [[TOBOOL_NOT4_I]], label [[COUNT_NODES_VARIANT3_EXIT:%.*]], label [[WHILE_BODY_I:%.*]]
; ALL:       while.body.i:
; ALL-NEXT:    [[SIZE_06_I:%.*]] = phi i64 [ [[INC_I:%.*]], [[WHILE_BODY_I]] ], [ 0, [[ENTRY:%.*]] ]
; ALL-NEXT:    [[P_ADDR_05_I:%.*]] = phi ptr [ [[TMP0:%.*]], [[WHILE_BODY_I]] ], [ [[P]], [[ENTRY]] ]
; ALL-NEXT:    [[TMP0]] = load ptr, ptr [[P_ADDR_05_I]], align 8
; ALL-NEXT:    [[INC_I]] = add i64 [[SIZE_06_I]], 1
; ALL-NEXT:    [[TOBOOL_NOT_I:%.*]] = icmp eq ptr [[TMP0]], null
; ALL-NEXT:    br i1 [[TOBOOL_NOT_I]], label [[COUNT_NODES_VARIANT3_EXIT_LOOPEXIT:%.*]], label [[WHILE_BODY_I]], !llvm.loop [[LOOP2:![0-9]+]]
; ALL:       count_nodes_variant3.exit.loopexit:
; ALL-NEXT:    [[TMP1:%.*]] = icmp ne i64 [[INC_I]], 0
; ALL-NEXT:    br label [[COUNT_NODES_VARIANT3_EXIT]]
; ALL:       count_nodes_variant3.exit:
; ALL-NEXT:    [[SIZE_0_LCSSA_I:%.*]] = phi i1 [ false, [[ENTRY]] ], [ [[TMP1]], [[COUNT_NODES_VARIANT3_EXIT_LOOPEXIT]] ]
; ALL-NEXT:    ret i1 [[SIZE_0_LCSSA_I]]
;
entry:
  %p.addr = alloca ptr, align 8
