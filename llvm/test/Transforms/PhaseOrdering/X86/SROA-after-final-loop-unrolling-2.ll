...
; CHECK-NEXT:    [[I11_NOT4:%.*]] = icmp ult i32 [[ARG_OFF]], 255
; CHECK-NEXT:    br i1 [[I11_NOT4]], label [[BB12:%.*]], label [[BB13:%.*]]
; CHECK:       bb12.loopexit:
; CHECK-NEXT:    [[I3_SROA_6_0_INSERT_EXT:%.*]] = sext i32 [[I21_1:%.*]] to i64
; CHECK-NEXT:    [[I3_SROA_6_0_INSERT_SHIFT:%.*]] = shl nuw nsw i64 [[I3_SROA_6_0_INSERT_EXT]], 32
; CHECK-NEXT:    [[I3_SROA_0_0_INSERT_EXT:%.*]] = sext i32 [[I21:%.*]] to i64
; CHECK-NEXT:    [[I3_SROA_0_0_INSERT_INSERT:%.*]] = or i64 [[I3_SROA_6_0_INSERT_SHIFT]], [[I3_SROA_0_0_INSERT_EXT]]
; CHECK-NEXT:    br label [[BB12]]
; CHECK:       bb12:
; CHECK-NEXT:    [[TMP0:%.*]] = phi i64 [ [[I3_SROA_0_0_INSERT_INSERT]], [[BB12_LOOPEXIT:%.*]] ], [ 180388626456, [[BB:%.*]] ]
; CHECK-NEXT:    store i64 [[TMP0]], ptr [[ARG1:%.*]], align 4, !tbaa [[TBAA5:![0-9]+]]
; CHECK-NEXT:    ret void
; CHECK:       bb13:
; CHECK-NEXT:    [[I3_SROA_6_0:%.*]] = phi i32 [ [[I21_1]], [[BB13]] ], [ 42, [[BB]] ]
; CHECK-NEXT:    [[I3_SROA_0_0:%.*]] = phi i32 [ [[I21]], [[BB13]] ], [ 24, [[BB]] ]
; CHECK-NEXT:    [[I4_05:%.*]] = phi i32 [ [[I24_1:%.*]], [[BB13]] ], [ 0, [[BB]] ]
; CHECK-NEXT:    [[I21]] = mul nsw i32 [[I3_SROA_0_0]], [[I4_05]]
; CHECK-NEXT:    [[I24:%.*]] = or i32 [[I4_05]], 1
; CHECK-NEXT:    [[I21_1]] = mul nsw i32 [[I3_SROA_6_0]], [[I24]]
; CHECK-NEXT:    [[I24_1]] = add nuw nsw i32 [[I4_05]], 2
; CHECK-NEXT:    [[I11_NOT_1:%.*]] = icmp eq i32 [[I24_1]], [[I10]]
; CHECK-NEXT:    br i1 [[I11_NOT_1]], label [[BB12_LOOPEXIT]], label [[BB13]], !llvm.loop [[LOOP8:![0-9]+]]
;
bb:
