...
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP22:%.*]] = sext i32 [[MUL]] to i64
...
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP24:%.*]] = sext i32 [[ADD]] to i64
...
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP26:%.*]] = sext i32 [[MUL]] to i64
...
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP27:%.*]] = sext i32 [[ADD]] to i64
...
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP8:%.*]] = sext <vscale x 16 x i32> [[TMP7]] to <vscale x 16 x i64>
...
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP12:%.*]] = sext <vscale x 16 x i32> [[TMP11]] to <vscale x 16 x i64>
...
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP17:%.*]] = sext i32 [[MUL]] to i64
...
; SCALAR_TAIL_FOLDING:       if.then:
; SCALAR_TAIL_FOLDING-NEXT:    [[ADD:%.*]] = or i32 [[MUL]], 1
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP18:%.*]] = sext i32 [[ADD]] to i64
...
; PREDICATED_TAIL_FOLDING-NEXT:    [[TMP7:%.*]] = sext <vscale x 16 x i32> [[TMP6]] to <vscale x 16 x i64>
...
; PREDICATED_TAIL_FOLDING-NEXT:    [[TMP11:%.*]] = sext <vscale x 16 x i32> [[TMP10]] to <vscale x 16 x i64>
...
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP9:%.*]] = sext <vscale x 16 x i32> [[TMP7]] to <vscale x 16 x i64>
...
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP13:%.*]] = sext <vscale x 16 x i32> [[TMP12]] to <vscale x 16 x i64>
...
; SCALAR_TAIL_FOLDING:       if.then:
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP18:%.*]] = sext i32 [[MUL]] to i64
...
; SCALAR_TAIL_FOLDING-NEXT:    [[ADD:%.*]] = or i32 [[MUL]], 1
; SCALAR_TAIL_FOLDING-NEXT:    [[TMP19:%.*]] = sext i32 [[ADD]] to i64
...
; PREDICATED_TAIL_FOLDING-NEXT:    [[TMP8:%.*]] = sext <vscale x 16 x i32> [[TMP6]] to <vscale x 16 x i64>
...
; PREDICATED_TAIL_FOLDING-NEXT:    [[TMP13:%.*]] = sext <vscale x 16 x i32> [[TMP12]] to <vscale x 16 x i64>
