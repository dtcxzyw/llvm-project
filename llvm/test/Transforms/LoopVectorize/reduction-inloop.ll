...
; CHECK-NEXT:    [[TMP5:%.*]] = sext <4 x i8> [[NARROW]] to <4 x i32>
...
; CHECK-NEXT:    [[DIV4:%.*]] = sext i8 [[TMP13]] to i32
...
; CHECK-NEXT:    [[TMP3:%.*]] = shl nuw nsw <4 x i8> [[TMP2]], <i8 3, i8 3, i8 3, i8 3>
; CHECK-NEXT:    [[TMP4:%.*]] = udiv <4 x i8> [[TMP3]], <i8 31, i8 31, i8 31, i8 31>
; CHECK-NEXT:    [[TMP5:%.*]] = sext <4 x i8> [[TMP4]] to <4 x i32>
...
; CHECK-NEXT:    [[DIV4:%.*]] = sext i8 [[TMP17]] to i32
; CHECK-NEXT:    [[REASS_ADD:%.*]] = shl nuw nsw i32 [[DIV4]], 1
...
; CHECK-NEXT:    [[TMP50:%.*]] = sext i4 [[TMP49]] to i32
