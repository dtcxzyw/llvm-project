...
; RUN: opt -S -passes=simplifycfg -mtriple=x86_64-unknown-unknown -mattr=+bmi < %s | FileCheck %s
; RUN: opt -S -passes=simplifycfg -mtriple=x86_64-unknown-unknown -mattr=+lzcnt < %s | FileCheck %s
; RUN: opt -S -passes=simplifycfg -mtriple=x86_64-unknown-unknown < %s | FileCheck %s
