...
; RUN: opt -mtriple=thumbv8.1m.main -passes=simplifycfg -S %s -o - | FileCheck %s --check-prefix=V8M
; RUN: opt -mtriple=thumbv8m.main -passes=simplifycfg -S %s -o - | FileCheck %s --check-prefix=V8M
; RUN: opt -mtriple=thumbv8m.base -passes=simplifycfg -S %s -o - | FileCheck %s --check-prefix=V8M
; RUN: opt -mtriple=armv8a -passes=simplifycfg -S %s -o - | FileCheck %s --check-prefix=V8A
