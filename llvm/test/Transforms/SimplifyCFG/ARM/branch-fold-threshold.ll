...
; RUN: opt -mtriple=thumbv8m.main %s -passes=simplifycfg -S | FileCheck %s --check-prefix=CHECK --check-prefix=THUMB
; RUN: opt -mtriple=thumbv8a %s -passes=simplifycfg -S | FileCheck %s --check-prefix=CHECK --check-prefix=THUMB
; RUN: opt -mtriple=armv8a %s -passes=simplifycfg -S | FileCheck %s --check-prefix=CHECK --check-prefix=ARM
