...
; RUN: opt < %s -S -passes=simplifycfg -bonus-inst-threshold=1 | FileCheck %s --check-prefixes=ALL,CHEAP
; RUN: opt < %s -S -passes=simplifycfg -bonus-inst-threshold=10 | FileCheck %s --check-prefixes=ALL,COSTLY
