...
; RUN: opt < %s -passes=simplifycfg -S -phi-node-folding-threshold=1 | FileCheck %s
; RUN: opt < %s -passes=simplifycfg -S -phi-node-folding-threshold=2 | FileCheck %s
; RUN: opt < %s -passes=simplifycfg -S -phi-node-folding-threshold=7 | FileCheck %s
