...
; RUN: opt < %s -S -passes=simplifycfg -bonus-inst-threshold=1 | FileCheck --check-prefixes=ALL,THR1 %s
; RUN: opt < %s -S -passes=simplifycfg -bonus-inst-threshold=2 | FileCheck --check-prefixes=ALL,THR2 %s
