; RUN: opt -S -passes=simplifycfg -mtriple=amdgpu6.00-unknown-unknown < %s | FileCheck -check-prefix=SI -check-prefix=ALL %s
; RUN: opt -S -passes=simplifycfg -mtriple=amdgpu8.02-unknown-unknown < %s | FileCheck -check-prefix=SI -check-prefix=ALL %s
