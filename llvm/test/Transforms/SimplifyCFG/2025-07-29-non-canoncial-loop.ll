...
; RUN: opt < %s -passes=simplifycfg --keep-loops="true" -S | FileCheck --check-prefix=NO-THREADING %s
...
; RUN: opt < %s -passes=simplifycfg --keep-loops="false" -S | FileCheck --check-prefix=THREADING %s
