...
; RUN: opt -passes=simplifycfg -hoist-common-insts=1 -S < %s                    | FileCheck %s --check-prefix=HOIST
; RUN: opt -passes=simplifycfg -hoist-common-insts=0 -S < %s                    | FileCheck %s --check-prefix=NOHOIST
; RUN: opt -passes=simplifycfg                       -S < %s                    | FileCheck %s --check-prefix=NOHOIST
