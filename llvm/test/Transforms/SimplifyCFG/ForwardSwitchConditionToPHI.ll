...
; RUN: opt < %s -passes=simplifycfg -forward-switch-cond=false -switch-range-to-icmp -S | FileCheck %s --check-prefix=NO_FWD
; RUN: opt < %s -passes=simplifycfg -forward-switch-cond=true  -switch-range-to-icmp -S | FileCheck %s --check-prefix=FWD
