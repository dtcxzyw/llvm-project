...
; RUN: llc -mtriple=amdgpu6.00 < %s | FileCheck -check-prefixes=GCN,WAVE64,SI %s
; RUN: llc -mtriple=amdgpu10.10 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GCN,WAVE64,GFX10-WAVE64 %s
; RUN: llc -mtriple=amdgpu10.10 < %s | FileCheck -check-prefixes=GCN,GFX10-WAVE32 %s
; RUN: llc -mtriple=amdgpu11.00 -mattr=+wavefrontsize64 < %s | FileCheck -check-prefixes=GCN,GFX11 %s
