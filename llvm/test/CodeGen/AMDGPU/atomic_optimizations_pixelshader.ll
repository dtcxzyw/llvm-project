...
; RUN: llc -mtriple=amdgpu6.00-- - -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX7 %s
; RUN: llc  -mtriple=amdgpu8.02-- -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX89,GFX8 %s
; RUN: llc -mtriple=amdgpu9.00-- -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX89,GFX9 %s
; RUN: llc -mtriple=amdgpu10.10-- -mattr=+wavefrontsize64 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1064 %s
; RUN: llc -mtriple=amdgpu10.10-- -mattr=+wavefrontsize32 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1032 %s
; RUN: llc -mtriple=amdgpu11.00-- -mattr=+wavefrontsize64 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1164 %s
; RUN: llc -mtriple=amdgpu11.00-- -mattr=+wavefrontsize32 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1132 %s
; RUN: llc -mtriple=amdgpu13.10-- -mattr=+wavefrontsize64 -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1364 %s
; RUN: llc -mtriple=amdgpu13.10-- -mattr=-flat-for-global - -amdgpu-atomic-optimizer-strategy=DPP < %s | FileCheck -enable-var-scope -check-prefixes=GFX1332 %s
...
; GFX1364-NEXT:    v_mad_u32_u24 v0, 5, v0, s4
; GFX1364-NEXT:  .LBB0_4: ; %Flow
...
; GFX1332-NEXT:    v_readfirstlane_b32 s4, v1
; GFX1332-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1332-NEXT:    v_mad_u32_u24 v0, 5, v0, s4
; GFX1332-NEXT:  .LBB0_4: ; %Flow
...
; GFX1364-NEXT:  ; %bb.2:
; GFX1364-NEXT:    v_mov_b32_e32 v0, s12
; GFX1364-NEXT:    buffer_atomic_add_u32 v0, off, s[4:7], null th:TH_ATOMIC_RETURN
; GFX1364-NEXT:  .LBB1_3:
; GFX1364-NEXT:    s_or_b64 exec, exec, s[10:11]
; GFX1364-NEXT:    s_wait_loadcnt 0x0
...
; GFX1332-NEXT:    ; implicit-def: $vgpr4
; GFX1332-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1332-NEXT:    s_mov_b32 s9, s8
; GFX1332-NEXT:    s_and_saveexec_b32 s8, s9
...
; GFX1332-NEXT:    v_readlane_b32 s11, v1, 31
...
; GFX1332-NEXT:    s_cbranch_execz .LBB1_3
; GFX1332-NEXT:  ; %bb.2:
; GFX1332-NEXT:    v_mov_b32_e32 v0, s11
; GFX1332-NEXT:    buffer_atomic_add_u32 v0, off, s[4:7], null th:TH_ATOMIC_RETURN
; GFX1332-NEXT:  .LBB1_3:
; GFX1332-NEXT:    s_or_b32 exec_lo, exec_lo, s9
; GFX1332-NEXT:    s_wait_loadcnt 0x0
...
; GFX1332-NEXT:    s_delay_alu instid0(VALU_DEP_1)
; GFX1332-NEXT:    v_add_nc_u32_e32 v4, s4, v0
; GFX1332-NEXT:  .LBB1_4: ; %Flow
; GFX1332-NEXT:    s_or_b32 exec_lo, exec_lo, s8
; GFX1332-NEXT:    s_wqm_b32 s4, -1
; GFX1332-NEXT:    s_delay_alu instid0(SALU_CYCLE_1) | instskip(NEXT) | instid1(SALU_CYCLE_1)
; GFX1332-NEXT:    s_and_b32 s4, s4, s4
