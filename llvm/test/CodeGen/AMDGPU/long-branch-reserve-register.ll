...
; RUN: llc -mtriple=amdgpu6.00 -amdgpu-s-branch-bits=4 < %s | FileCheck -enable-var-scope -check-prefix=GCN %s
...
; GCN-NEXT:    s_add_u32 s6, s6, (.LBB5_2-.Lpost_getpc4)&4294967295
; GCN-NEXT:    s_addc_u32 s7, s7, (.LBB5_2-.Lpost_getpc4)>>32
; GCN-NEXT:    s_setpc_b64 s[6:7]
; GCN-NEXT:  .LBB5_1: ; %bb3
; GCN-NEXT:    ;;#ASMSTART
; GCN-NEXT:    v_nop_e64
