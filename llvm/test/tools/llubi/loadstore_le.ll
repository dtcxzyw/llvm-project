...
; CHECK-NEXT:   %mixed_alloc = load b256, ptr %alloc_ptr_array, align 8 => b256 ptr 0x0 [nullary]ptr 0xD8 [alloc_ptr_array]ptr 0xD8 [nullary]ptr 0x7B38B97B869DF2A [nullary]
; CHECK-NEXT:   ret void
