...
; CHECK-NEXT:   %alloc_dyn = alloca i32, i32 4, align 4 => ptr 0x44 [alloc_dyn]
...
; CHECK-NEXT:   %gep_struct = getelementptr %struct, ptr %alloc_struct, i64 0, i32 1, i32 1 => ptr 0x64 [alloc_struct + 12]
